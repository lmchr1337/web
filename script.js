...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
	"\"Hello, World!\"",
    "My name is Laur and I make discord bots for fun. In order to contact me about a project you can send me a friend request via Discord.(lmchr1337)"
